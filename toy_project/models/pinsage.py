...
class PinSAGEModel(nn.Module):
    def __init__(self, full_graph, ntype, textsets, hidden_dim, n_layers):
        super().__init__()

        self.proj = layers.LinearProjector(full_graph, ntype, textsets, hidden_dim)
...
def train(dataset, args):
    ...
    # Model
    model = PinSAGEModel(g, item_ntype, textset, args.hidden_dim, args.num_layers).to(device)
    # Optimizer
